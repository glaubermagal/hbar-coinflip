      ...
      <div className="mx-auto max-w-7xl p-4 md:p-8">
        <div className="space-y-8">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="rounded-2xl bg-[rgba(0,0,0,0.7)] text-gray-200 p-6 shadow-sm">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="rounded-2xl bg-[rgba(0,0,0,0.7)] text-gray-200 p-6 shadow-sm lg:col-span-2">
            ...
            <div className="rounded-2xl bg-[rgba(0,0,0,0.7)] text-gray-200 p-6 shadow-sm space-y-6">
          ...
          <section className="rounded-2xl bg-[rgba(0,0,0,0.7)] text-gray-200 p-6 shadow-sm">
